...
public class Game_SB_Boom_Perk_Fx extends Game_Entity implements IFinals {
	private static double RADIUS = SB_BOOM_PERK_RADIUS;

	private Label slowText = new Label("SB-BOOM");
	private Circle slowCircle;
	private boolean taken = false;

	public Game_SB_Boom_Perk_Fx(double x) {
		super(x, 0, 0, 2.5, Color.BLACK);

		slowText.setTextFill(SB_BOOM_PERK_COLOR);
		slowText.setFont(Font.font(10));
